  ...
  public: {
    Tables: {
      ...
      admin_support_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_support_notes_admin_user_id_fkey"
            columns: ["admin_user_id"]
            isOneToOne: false
            referencedRelation: "admin_users"
            referencedColumns: ["user_id"]
          ...
          {
            foreignKeyName: "admin_support_notes_related_batch_id_fkey"
        ...
        Relationships: [
          {
            ...
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "admin_auth_user_summary"
            referencedColumns: ["id"]
          },
        ]
      }
