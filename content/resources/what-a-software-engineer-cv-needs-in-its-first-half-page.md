---
type: article
slug: what-a-software-engineer-cv-needs-in-its-first-half-page
...
A recruiter reads a CV against one specific job, and starts at the top. Whatever they find there either confirms a match or leaves them looking further down for one. The wider picture of how a recruiter judges a CV is in [how a recruiter evaluates your CV](/how-recruiters-evaluate-a-cv).
...
Software engineer postings often name a stack, and a recruiter's first check is whether yours overlaps it. [How to read a job description before you apply](/resources/how-to-read-a-job-description) explains how to work out what a posting is actually asking for.
...
Whether a project without a job title counts at all is a separate question, covered in [Do projects count without a job title?](/resources/do-projects-count-without-a-job-title). The point here is placement. The piece of work that is clearly yours belongs in the part of the page a recruiter reaches first, not in the last section.
...
A number that was not true is worse than none, because a recruiter can ask about it and the whole entry falls apart. The Interview Score works the same way: it credits what a CV demonstrates and gives nothing for a claim with no evidence behind it. [How the Interview Score works](/how-interview-score-works) sets out the method.
...
To see how the top of your resume reads against a specific posting, the [software engineer resume checker](/software-engineer-resume-checker) compares the two and reports whether your stack, ownership and outcome are shown with evidence or only named.
