...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Only a credited follow up (the score actually rose) counts as evidence
...
${context.hasFollowUpEvidence ? FOLLOW_UP_DOCUMENT_ADDENDUM : ''}
...
2. cover_letter: a premium, professional cover letter for this role, written by the candidate, to the company, in the candidate's own voice. Write in clear, direct, plain language, no jargon and no filler, confident and positive throughout, exactly what a recruiter wants to read. This is the single most important rule for this document: write every sentence in the first person ("I", "my", "me"), exactly as the candidate would write it themselves. Never refer to the candidate by name or in the third person anywhere in intro_paragraph, body_paragraphs, or conclusion_paragraph (wrong: "Maya is excited to apply... She has..."; right: "I am excited to apply... I have..."). Structured as:
   ...
   - body_paragraphs: exactly 3 short first person paragraphs, always in this order:
     ...
     3. Company research and culture fit: show that I have looked into this company and want this job specifically, not just any job. Connect my values and working style to the company's culture, mission, values or CSR commitments, drawing ONLY on what the job description and the company information provided below actually reveal (a stated mission, named values, how the team describes its way of working). When they reveal nothing about the company beyond the role itself, ground the paragraph in what the job description signals about how the team works and what it rewards, and connect my working style to that. Never invent named initiatives, programmes, awards, or any fact about the company that does not appear in the provided context. Blend in genuine soft skills (collaboration, independence, mentoring, time management) where they support the culture fit rather than listing them on their own. Keep this authentic and specific, not generic corporate language. Start this paragraph with a natural transition word or phrase.
