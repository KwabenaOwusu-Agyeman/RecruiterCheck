    ...
    <SeoLandingPage
      ...
      comparison={{
        ...
        rows: [
          ...
          { label: 'Paid plans start at', us: '€9.99 per week', them: '$24 per month (or $8 per month billed yearly)' },
        ],
      }}
      faqs={[
        ...
        { question: 'Is MyRecruiterCheck cheaper than Kickresume?', answer: 'MyRecruiterCheck\'s paid plans start at €9.99 per week, compared to Kickresume Premium\'s monthly rate of $24, or $8 per month if billed yearly.' },
