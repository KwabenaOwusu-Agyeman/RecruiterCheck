  ...
  return (
    <SeoLandingPage
      ...
      steps={[
        ...
        'Get an Interview Probability and recruiter-style feedback, not just a keyword match rate.',
      ]}
      comparison={{
        competitor: 'Jobscan',
        rows: [
          ...
          { label: 'Paid plans start at', us: '€9.99 per week', them: '$29.98 per month' },
        ],
      }}
      faqs={[
        { question: 'Is MyRecruiterCheck cheaper than Jobscan?', answer: 'Yes. MyRecruiterCheck\'s paid plans start at €9.99 per week, compared to Jobscan\'s lowest paid plan at $29.98 per month.' },
