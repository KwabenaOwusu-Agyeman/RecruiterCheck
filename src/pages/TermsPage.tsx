  ...
  return (
    <LegalLayout title="Terms of Service" updated="7 August 2026">
      <Section title="1. Introduction">
        <p>
          These Terms of Service ("Terms") govern your access to and use of RecruiterCheck (the
      ...
      <Section title="2. The Service">
        <p>
          RecruiterCheck lets you upload a CV and a job description to receive AI generated
          ...
          for informational purposes only; RecruiterCheck does not guarantee interviews, job
      ...
      <Section title="5. No Refunds">
        <p>
          All payments are final. RecruiterCheck does not offer refunds or credits for partial
      ...
      <Section title="8. Your Content">
        <p>
          ...
          Content"). You grant RecruiterCheck a limited license to process Your Content, including
      ...
      <Section title="9. AI Generated Content">
        <p>
          ...
          RecruiterCheck is not responsible for decisions made based on AI generated output.
        </p>
      </Section>

      <Section title="10. Intellectual Property">
        <p>
          The Service, including its design, code, and branding, is owned by RecruiterCheck and
      ...
      <Section title="13. Limitation of Liability">
        <p>
          To the maximum extent permitted by law, RecruiterCheck shall not be liable for any
