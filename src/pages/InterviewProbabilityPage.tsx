  ...
  return (
    <SeoLandingPage
      ...
      steps={[
        ...
        'Receive an Interview Probability broken down by experience, skills and candidate value.',
      ...
      example={{
        ...
        insight: 'Their experience and skills factors were nearly identical. The difference was candidate value: one CV gave the recruiter a concrete, credible reason to interview that person over other applicants with the same background, and the other didn\'t. Interview Probability reflected that gap directly, which is the factor most CVs are weakest on and easiest to fix without adding new experience.',
      }}
      faqs={[
        { question: 'What is Interview Probability?', answer: 'It\'s an estimate of how strongly your CV matches a specific job, based on your relevant experience, required skills and overall candidate value as demonstrated in your CV.' },
        { question: 'Does a high Interview Probability guarantee an interview?', answer: 'No. It\'s an evidence-based estimate, not a hiring guarantee. Recruiters weigh other candidates and factors outside your CV and the job description.' },
        { question: 'Why did my score change after I edited my CV?', answer: 'Interview Probability is recalculated from what\'s actually written in your CV. Adding specific, credible evidence for a weak factor — usually candidate value — typically has the biggest effect.' },
        { question: 'Is this the same as an ATS score?', answer: 'No. An ATS score usually measures keyword overlap. Interview Probability evaluates whether your experience, skills and value are genuinely demonstrated, the way a recruiter would read your CV.' },
      ]}
      relatedLinks={[
