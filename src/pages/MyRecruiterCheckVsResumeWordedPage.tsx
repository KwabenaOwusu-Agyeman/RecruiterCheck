  ...
  return (
    <SeoLandingPage
      ...
      benefits={[
        ...
        { title: 'Interview Probability included from the start', description: 'See an evidence-based estimate of your chances, not just a score out of 100.' },
      ...
      faqs={[
        ...
        { question: 'Is MyRecruiterCheck\'s free check limited like Resume Worded\'s?', answer: 'No. Your first Recruiter Check includes full feedback and an Interview Probability, not a limited preview.' },
