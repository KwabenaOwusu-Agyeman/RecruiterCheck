  ...
  return (
    <SeoLandingPage
      ...
      steps={[
        ...
        'Review your Interview Probability, strengths and areas to improve, and adjust your CV accordingly.',
      ]}
      example={{
      ...
      faqs={[
        ...
        { question: 'What feedback will I receive?', answer: 'You receive an Interview Probability, strengths, genuine areas to improve, and prospects based only on the evidence in your CV and the job description.' },
