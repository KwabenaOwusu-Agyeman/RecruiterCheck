    ...
    <section ref={sectionRef} className="border-b border-border bg-surface">
      <Container className="py-[32px] sm:py-12 lg:py-[64px]">
        <motion.div
          ...
          className="mx-auto max-w-xl text-center sm:max-w-none sm:rounded-[20px] sm:bg-navy sm:px-8 sm:py-12 sm:shadow-glow lg:mx-auto lg:max-w-[1120px] lg:rounded-[24px] lg:px-[64px] lg:py-[64px]">
