...
follow up result anywhere new (Control Centre, emails, documents), reuse
`isCandidateReportedEvidence` or check provenance the same way. The durable
fix is the reassessment recording provenance per excerpt, an Edge Function
